...
import {MAX_DRAG_RATIO, MAX_SCALE_ALLOW, SCALE_DECIMAL_PLACES} from "../../constants/constants"
...
const MockupEditor = ({
    ...
    const updateDisplay = () => {
        ...
        if (sideArtwork && target && container) {
            ...
            const scale = sideArtwork.scale || [1, 1]
            let frameWidth = container.clientWidth
            let frameHeight = container.clientHeight
            let translateRatio = sideArtwork.translateRatio
            const translate = (translateRatio && [translateRatio[0] * frameWidth, translateRatio[1] * frameHeight]) || sideArtwork.translate
                || [0, 0]
